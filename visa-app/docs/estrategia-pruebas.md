...
| BE-01 | Backend | `backend/app.js` | `GET /validar-sesion` | Validar correo existente | `pg.Pool` mockeado | `correo=valido@example.com` | GET | `200`, `{ valid: true }` | HTTP | `pg.Pool` | Alta |
| BE-02 | Backend | `backend/app.js` | `GET /validar-sesion` | Validar correo inexistente | `pg.Pool` mockeado | `correo=invalido@example.com` | GET | `200`, `{ valid: false }` | HTTP | `pg.Pool` | Alta |
