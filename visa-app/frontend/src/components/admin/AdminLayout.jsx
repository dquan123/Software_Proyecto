...
const adminNavItems = [
  ...
  { label: "Pagos y citas", path: "/admin/consular", icon: <ReceiptText size={20} strokeWidth={2} aria-hidden="true" /> },
  ...
  { label: "Recordatorios", path: "/admin/email-reminders", icon: <MailCheck size={20} strokeWidth={2} aria-hidden="true" /> },
];
