...
export default function AdminAssignments() {
  ...
  return <AdminLayout><AdminPageHeader description="Asigna solicitudes pendientes a los asesores disponibles." />{notice && <p className="admin-feedback" role="status">{notice}</p>}<AdminResourceState {...resource} isEmpty={!cases.length && !advisors.length} empty="No hay solicitudes ni asesores disponibles." />
